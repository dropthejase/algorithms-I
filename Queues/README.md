...
----------------------------------
5.9K Mar 25 23:21 Deque.java
 568 Mar 25 23:21 Permutation.java
4.4K Mar 25 23:21 RandomizedQueue.java
...
Test 7a: Insert 100 strings; delete them one at a time, checking
    ...
    - loitering observed during 82 of 100 deletions
    - maximum number of loitered objects at one time = 20
...
Test 7b: Perform random operations, checking for loitering after
  ...
  * 200 random operations (0.8, 0.2, 0.0)
    - loitering detected after operation 108 of 200
  * 200 random operations (0.2, 0.8, 0.0)
    - loitering detected after operation 2 of 200
    - sequence of operations was:
         rq.enqueue("XOKNLIORNR")
         rq.dequeue()     ==> "XOKNLIORNR"
    - loitered object(s):
      XOKNLIORNR
  ...
  * 200 random operations (0.2, 0.4, 0.4)
    ...
    - sequence of operations was:
         rq.enqueue("PSNXKOHKYI")
         rq.enqueue("SNWYYNXNTT")
         rq.sample()      ==> "PSNXKOHKYI"
         rq.sample()      ==> "PSNXKOHKYI"
         rq.dequeue()     ==> "SNWYYNXNTT"
         rq.dequeue()     ==> "PSNXKOHKYI"
    - loitered object(s):
      PSNXKOHKYI
...
Memory: 32.00 n - 8.00   (R^2 = 1.000)


Min observed memory for RandomizedQueue: 8.00 n + 56.00   (R^2 = 1.000)
Max observed memory for RandomizedQueue: 32.00 n - 8.00   (R^2 = 1.000)
